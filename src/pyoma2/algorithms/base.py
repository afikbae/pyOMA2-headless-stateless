...
class BaseAlgorithm(typing.Generic[T_RunParams, T_MPEParams, T_Result, T_Data], abc.ABC):
    ...
    @abc.abstractmethod
    def mpe(self, result: T_Result, *args, **kwargs) -> T_Result:
        """
        ...
        ----------
        result: T_Result
            The result object from the `run` method.
        *args : tuple
        ...
        **kwargs : dict
        ...
        -------
        T_Result
            The result object updated with the extracted modal parameters.
        ...
        NotImplementedError
            If the method is not implemented in the subclass.
        ValueError
            If the result object is not provided.
        ...
        """
        if not result:
            raise ValueError("Result object must be provided.")
